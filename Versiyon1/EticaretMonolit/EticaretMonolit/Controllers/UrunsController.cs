...
namespace EticaretMonolit.Controllers
{
    ...
    {
        private readonly EticaretMonolitContext _context;

        public UrunsController(EticaretMonolitContext context)
        {
            _context = context;
        }
        ...
        {
            var eticaretMonolitContext = _context.Urun.Include(u => u.Kategori);
            return View(await eticaretMonolitContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Adi,Stok,Resim,Aciklama,KategoriId")] Urun urun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adi,Stok,Resim,Aciklama,KategoriId")] Urun urun)
        {
            if (id != urun.Id)
            {
                return NotFound();
